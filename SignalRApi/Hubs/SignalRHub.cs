...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public async Task SendStatistic()
        {
			...
			var value10 = _productService.TProductAvgPriceByHumberger();
			await Clients.All.SendAsync("ReceiveProductAvgPriceByHumberger", value10.ToString("0.00") + "₺");
		...
		public async Task SendProgress()
		{
			...
			await Clients.All.SendAsync("ReceiveActiveOrderCount", value2.ToString() + " " + "ADET");
			...
			var value6 = _productService.TProductAvgPriceByHumberger();
			await Clients.All.SendAsync("ReceiveProductAvgPriceByHumberger", value6);
        ...
        public override async Task OnConnectedAsync() // client(istemci)'a bağlı olan client sayısını getiriyor.
        {
			ClientCount++;
