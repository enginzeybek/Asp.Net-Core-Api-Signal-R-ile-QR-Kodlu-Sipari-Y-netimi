...
using SignalRWepUI.DTOs.MenuTableDto;
...
namespace SignalRWepUI.Controllers
{
	public class MenuTablesController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:7277/api/MenuTables");
		...
		public async Task<IActionResult> CreateMenuTable(CreateMenuTableDto createMenuTableDto)
		{
			...
			var responseMessage = await client.PostAsync("https://localhost:7277/api/MenuTables", stringContent);
		...
		public async Task<IActionResult> DeleteMenuTable(int id)
		{
			...
			var responseMessage = await client.DeleteAsync($"https://localhost:7277/api/MenuTables/{id}");
		...
		public async Task<IActionResult> UpdateMenuTable(int id)
		{
			...
			var responseMesaage = await client.GetAsync($"https://localhost:7277/api/MenuTables/{id}");
		...
		public async Task<IActionResult> UpdateMenuTable(UpdateMenuTableDto updateMenuTableDto)
		{
			...
			var responseMessage = await client.PutAsync("https://localhost:7277/api/MenuTables/", stringContent);
